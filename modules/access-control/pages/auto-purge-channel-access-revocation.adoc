...
:page-aliases: anchor-auto-purge-channel-access-revocation, ROOT:auto-purge-channel-access-revocation.adoc
...
You can opt-in to auto-purge behavior using the replicator level option `purge_on_removal` in the REST API -- see: xref:configuration:configuration-schema-isgr.adoc#replication-purge_on_removal[replication-purge_on_removal].
