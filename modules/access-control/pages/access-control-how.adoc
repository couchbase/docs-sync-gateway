...
:page-aliases: ROOT:access-control-how.adoc
...
* Legacy Pre 3.0: Use the xref:configuration:configuration-properties-legacy.adoc[Legacy Configuration Properties] file's xref:configuration:configuration-properties-legacy.adoc#databases-user-admin-channels[admin_user_channels]
* Dynamically
...
[#img-channel-access]
====
image::ROOT:channel-access-grant-all.png[,400]
