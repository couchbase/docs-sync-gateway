...
:page-aliases: getting-started, ROOT:start/get-started-install.adoc
...
You can install Sync Gateway on any of the xref:product-notes:supported-environments.adoc[supported operating systems].
...
image::ROOT:windows-installation-complete.png[]
