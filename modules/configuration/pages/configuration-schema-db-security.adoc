...
include::ROOT:partial$static_restapi/admin/index.adoc[tags=put_db-_role-name,leveloffset=+1]
...
include::ROOT:partial$static_restapi/admin/index.adoc[tags=put_db-_user-name,leveloffset=+1]
