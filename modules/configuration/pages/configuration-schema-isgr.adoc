...
This page introduces the <<put_db-_replication-replicationid,Add or Update a Replication>> endpoint for convenience -- see {rest-api-admin--xref--replication} for a full description of the endpoints available.
...
include::ROOT:partial$static_restapi/admin/index.adoc[tags=put_db-_replication-replicationid,leveloffset=+1]
