...
For complete endpoint details, including all request parameters and response codes, refer to {rest-api-admin--xref--database-management--put-db} in the Admin REST API.
...
For complete endpoint details, including all request parameters and response codes, refer to {rest-api-admin--xref--database-configuration--post-db-config} in the Admin REST API.
