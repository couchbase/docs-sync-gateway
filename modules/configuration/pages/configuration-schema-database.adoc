...
User creation initializes access control for all associated collections, while database creation initializes Sync Gateway indexes (`sg_` prefixed) for new collections.


[#lbl-create-db]
include::ROOT:partial$static_restapi/admin/index.adoc[tags="put_db-",leveloffset=+1]
...
[#lbl-configure-db]
include::ROOT:partial$static_restapi/admin/index.adoc[tags="post_db-_config",leveloffset=+1]
