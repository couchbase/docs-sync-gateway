...
.Sync
  ...
  * Inter-Sync Gateway Replication
    ...
    ** xref:sync:sync-inter-syncgateway-conflict-resolution.adoc[Inter Sync Gateway Conflict Resolution]
...
.Manage
  ...
  * xref:manage:channel-history.adoc[Channel History Management]
...
.Upgrade
  ...
  * xref:ROOT:migrate-metadata-system-collection.adoc[Migrate Metadata to System Collection]
...
.Server Compatibility
  ...
  * xref:server-compatibility:server-compatibility-xdcr-mobile.adoc[Bi-directional XDCR with Mobile Clusters]
