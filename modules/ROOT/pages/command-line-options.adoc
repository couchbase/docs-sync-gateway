...
WARNING: The `-bucket` command line option is deprecated at Release 2.7. It will be removed in Release 2.10. *Instead*, use the JSON configuration file option `bucket` -- see link:config-properties.html#databases-this_db-bucket[$dbname.bucket]
