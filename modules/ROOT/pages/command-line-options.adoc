...
:topic-group: Deploy
:param-related: {xref-sgw-pg-deployment}  |  {rest-api-access--xref}  |  {configuration-schema-static--xref}
...
For more comprehensive configuration, use a JSON configuration file - see: {configuration-schema-static--xref}.
...
Use the JSON configuration file option `bucket` -- see {configuration-schema-static--xref--databases-bucket}.
