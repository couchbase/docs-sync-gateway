...
- In a Sync Gateway deployment with xref:index.adoc#guaranteed-availability[GSI/N1QL indexing], the resources allocated to the Couchbase Server index node must be sufficient to support Sync Gateway operations.