...
You should refer to the {configuration-overview--xref} for more on the configuration process and to the  {configuration-schema--xref} for details on the configuration options.
