...
== Beta Release Only
{sgw-te} 3.0.0 BETA01 is available for all {sgw--xref}{supported-environments--page}[supported operating systems] as a direct download only.
...
* {beta-url}couchbase-sync-gateway-enterprise_3.0.0-beta01_aarch64.rpm[couchbase-sync-gateway-enterprise_3.0.0-beta01_aarch64.rpm]
