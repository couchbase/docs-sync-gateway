...
Sync Gateway's access control configuration settings are shown in the <<lbl-schema>>. The settings are provisioned through the REST API/ -- see: {rest-api-admin-user--xref}
