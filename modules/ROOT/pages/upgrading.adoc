...
Removal of the obsolete design documents is done via a call to the xref:rest_api_admin.adoc#tag/Server/operation/post__post_upgrade[+/_post_upgrade+] endpoint in Sync Gateway`'s Admin REST API.
...
The xref:rest_api_admin.adoc#tag/Document/operation/get_keyspace-_raw-docid[raw]
