...
Starting in 2.1, Sync Gateway will use GSI and {sqlpp} to perform those tasks.

The upgrade, from using views to using Global Secondary Indexes and {sqlpp}, happens automatically when starting a Sync Gateway 2.1 or above node in a cluster that was previously using views.
