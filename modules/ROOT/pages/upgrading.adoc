...
The use of 3.0 BETA's Persistent Configuration feature is strongly recommended.
...
Just startup a {sgw} node using your existing configuration properties file.
{sgw-t} will take the appropriate upgrade path as shown in <<tbl-enhancedcfg>>.
