...
The use of 3.0's Persistent Configuration feature is strongly recommended.
...
[CAUTION]
--
The migration to 3.0 configuration is a ONE WAY process; to continue using legacy-mode configuration see: <<lbl-3-0-upgrade-opt-out>>
--
