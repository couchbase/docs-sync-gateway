...
- https://github.com/couchbase/sync_gateway/issues/3655[*#3655*] Sgcollect rest API does not create zip files under /home/sync-gateway
...
Removal of the obsolete design documents is done via a call to the new xref:admin-rest-api.adoc#/server/post__post_upgrade[+/{db}/_post_upgrade+] endpoint in Sync Gateway`'s Admin REST API.
