...
[CAUTION]
--
The migration to an 4.x configuration is a ONE WAY process -- see: {upgrading--xref} for more.
--

:param-release-tag: -1

[#maint-latest]
include::partial$release_notes/sync-gateway-4-0-0-release-note.adoc[]
