...
| SG-Replicate | xref:legacy-sg-replicate.adoc[Legacsy -- SG-Replicate] | Dropped

| enable_shared_bucket_access -- enabled by default | xref:config-properties.adoc#databases-this_db-enable_shared_bucket_access[enable_shared_bucket_access] | breaks compatibility
...
| configServer property | xref:config-properties.adoc#configServer[configserver] | Dropped

| old cache config values :databases.this_db.cache.max_wait_pending | xref:config-properties.adoc#databases-this_db-cache-max_wait_pending[db-cache-max_wait_pending] | Dropped

| old cache config values :databases.this_db.cache.max_num_pending | xref:config-properties.adoc#databases-this_db-cache-max_num_pending[max_num_pending] | Dropped

| old cache config values :databases.this_db.cache.max_wait_skipped | xref:config-properties.adoc#databases-this_db-cache-max_wait_skipped[max_num_skipped] | Dropped

| old cache config values :databases.this_db.cache.enable_star_channel | xref:config-properties.adoc#databases-this_db-cache-enable_star_channel[enable_star_channel] | Dropped

| old cache config values :databases.this_db.cache.channel_cache_max_length | xref:config-properties.adoc#databases-this_db-cache-channel_cache_max_length[channel_cache_max_length] | Dropped

| old cache config values :databases.this_db.cache.channel_cache_min_length | xref:config-properties.adoc#databases-this_db-cache-channel_cache_min_length[channel_cache_min_length] | Dropped

| databases.this_db.cache.channel_cache_expiry | xref:config-properties.adoc#databases-this_db-cache-channel_cache_expiry[channel_cache_expiry] | Dropped

| databases.this_db.feed_type | xref:config-properties.adoc#databases-this_db-feed_type[feed_type] | Dropped

| old cache config values: databases.this_db.rev_cache_size | xref:config-properties.adoc#databases-this_db-rev_cache_size[rev_cache_size] | Dropped

| Facebook User Auth Config | xref:config-properties.adoc#facebook[facebook] | Deprecated

| Google User Auth Config | xref:config-properties.adoc#facebook[Google] | Deprecated

| allow_conflicts confg | xref:config-properties.adoc#databases-this_db-allow_conflicts[allow_conflicts] | Deprecated

| walrus (should not be default database mode) | xref:config-properties.adoc#databases-this_db-server[server] | Dropped
