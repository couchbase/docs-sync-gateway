...
To continue using legacy Pre-3.0 BETA configuration you should start {sgw} with {configuration-properties--xref-disable-persistent-config} set `true` either in the configuration file or in {command-line-options--xref}.
