...
For documentation on inter-Sync{nbsp}Gateway replication in Sync Gateway 2.8+ see {sync-inter-syncgateway-overview--page}
...
[{caveat-level}]
--
This content describes configuration for Sync Gateway 3.0-beta02 and higher -- for legacy configuration, see: {configuration-properties-legacy--xref}
--
