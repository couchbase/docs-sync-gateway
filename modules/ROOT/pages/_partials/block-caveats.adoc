...
[CAUTION]
--
This content covers  SG Replicate - inter-Sync Gateway replication in pre-2.8 versions of Sync Gateway.
// tag::icr-sgr2-redirect[]
For documentation on inter-Sync{nbsp}Gateway Replication features introduced in Sync Gateway 2.8 see {xref-sgw-pg-icr-sgreplicate}
...
[CAUTION]
--
This content relates only to inter-Sync Gateway replication introduced in Sync Gateway 2.8.
// tag::icr-sgr1-redirect[]
For documentation on SG{nbsp}Replicate -- see {xref-sgw-pg-icr-sgreplicate-sgr1}
