...
[CAUTION]
--
This content covers SG Replicate replications.
// tag::icr-sgr2-redirect[]
For documentation on Inter-Sync{nbsp}Gateway Replication features see {xref-sgw-pg-icr-sgreplicate}
...
[CAUTION]
--
This content relates only to Inter-Sync Gateway Replication.
