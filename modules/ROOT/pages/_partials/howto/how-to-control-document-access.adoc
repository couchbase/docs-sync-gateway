...
Using the appropriate `admin_channels` property in the {configuration-properties--xref}. +
...
* Starting 3.0, the role can be specified within a special user-defined xattr associated with the document -- see: {access-control-how-use-xattrs-for-access-grants--xref}.
