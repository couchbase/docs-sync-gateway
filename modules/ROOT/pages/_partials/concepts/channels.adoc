...
You can access this metadata using the xref:rest-api-admin.adoc#tag/Document[Admin REST API Document endpoint], which returns the document's `_sync` metadata in the response.
