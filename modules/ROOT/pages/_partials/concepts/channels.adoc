...
[#lbl-usecase]
== Use Case
Consider the case where two users require, and are allowed, access to a private set of documents  and one shared set of documents — see <<fig-channel-example>>.
