...
// * Configuration -- You can do it in the {configuration-properties--xref} by adding the appropriate channel to the user's `admin_channels` property in the  see {configuration-properties--xref--databases-user-admin-channels}
...
// +
// --
// Do this either by using the Admin REST API endpoint  {rest-api-admin-role-post--xref} or statically by adding the role to the database in the {configuration-properties--xref}.
