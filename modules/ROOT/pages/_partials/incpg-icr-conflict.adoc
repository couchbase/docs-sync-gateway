...
You can learn more about the ($db.custom_conflict_resolver) property in the Configuration Schema Reference -- see: {configuration-schema-static--xref--db-rep-resolver}.
