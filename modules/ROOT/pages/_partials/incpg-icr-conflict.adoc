...
In _Pull_ replications the _active_ Sync Gateway detects and resolves conflicts based on its configured {configuration-properties--xref--db-rep-conflict} and _conflict resolver policy_.
