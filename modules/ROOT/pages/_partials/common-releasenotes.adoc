...
In order to support the version of Inter-Sync Gateway Replication introduced with 2.8, all nodes in the active cluster must be running Sync Gateway 2.8+.
...
* For Sync Gateway 2.8+ -- you may run the version of Inter-Sync Gateway Replication introduced in 2.8 or SG{nbsp}Replicate (deprecated)
