...
However, root level replications (which by definition, use Inter-Sync Gateway Replication v1) will continue to support remote replications, albeit in the now deprecated feature.
