...
:configuration-schema--page: configuration-properties.adoc
...
:sgw-pg-legacy-logging-pre2-1: legacy-logging-pre2-1.adoc
...
:xref-sgw-ep-admin-api-replication-delete: {xref-sgw--pfx-admin-api-replication}/delete__db___replication__replicationID_[DELETE/\{tkn-url}/\{db}/_replication/example-rep-db1]
:xref-sgw-ep-admin-api-replication-post-remote: {xref-sgw--pfx-admin-api-replication-post}[remote]
:xref-sgw-ep-admin-api-replication-post: {xref-sgw--pfx-admin-api-replication-post}[POST/\{tkn-url}/\{db}/_replication/example-rep-db1]
:xref-sgw-ep-admin-api-replication-put: {xref-sgw--pfx-admin-api-replication}/put__db___replication__replicationID_[PUT/\{tkn-url}/\{db}/_replication/example-rep-db1]
