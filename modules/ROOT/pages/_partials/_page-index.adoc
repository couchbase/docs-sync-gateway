...
:command-line-options--xref: {sgw--xref}{command-line-options--page}[Using Command Line]
...
:data-modeling--xref: {sgw--xref}{data-modeling--page}[Data Modelling]
:get-started-access-rest-api--xref: {sgw--xref}{get-started-access-rest-api}[REST API Access]
:get-started-access-rest-api: get-started-access-rest-api.adoc
:get-started-configure-server--xref: {sgw--xref}{get-started-configure-server}[Configure Server for Sync Gateway]
:get-started-configure-server: get-started-configure-server.adoc
:get-started-install--xref: {sgw--xref}{get-started-install}[Install]
:get-started-install: get-started-install.adoc
:get-started-prepare--xref: {sgw--xref}{get-started-prepare}[Prepare]
:get-started-prepare: get-started-prepare.adoc
:get-started-verify-install--xref: {sgw--xref}{get-started-verify-install}[Verify]
...
:rest-api-admin--xref: {sgw--xref}{rest-api-admin--page}[Admin REST API]
...
:xref-sgw--pfx-channels: {sgw--xref}{sgw-pg-channels}
:xref-sgw--pfx-icr-admin: {sgw--xref}{sgw-pg-icr-admin}
:xref-sgw--pfx-icr-conflict-resolution: {sgw--xref}{sgw-pg-icr-conflict-resolution}
:xref-sgw--pfx-icr-high-availability: {sgw--xref}{sgw-pg-icr-high-availability}
:xref-sgw--pfx-icr-initialize: {sgw--xref}{sgw-pg-icr-running}
:xref-sgw--pfx-icr-monitoring: {sgw--xref}{sgw-pg-icr-monitoring}
:xref-sgw--pfx-icr-overview: {xref-sgw--pfx-icr-sgreplicate}
:xref-sgw--pfx-icr-sgreplicate: {sgw--xref}{sgw-pg-icr-sgreplicate}
:xref-sgw--pfx-public-api-attachment: {xref-sgw-ep-public-api}#/attachment
:xref-sgw--pfx-read-access: {sgw--xref}{sgw-pg-read-access}
:xref-sgw--pfx-release-notes: {sgw--xref}{sgw-pg-release-notes}
:xref-sgw--pfx-write-access: {sgw--xref}{sgw-pg-write-access}
...
// :xref-sgw--pfx-icr-conflict-resolution-build: {sgw--xref}{sgw-pg-icr-conflict-resolution-build}
