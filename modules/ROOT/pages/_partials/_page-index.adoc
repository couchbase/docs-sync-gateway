...
:sgw-pg-rest-api: rest-api-public.adoc
:sgw-pg-rest-api-admin: rest-api-admin.adoc
:sgw-pg-rest-api-metrics: rest-api-metrics.adoc
:sgw-pg-running-replications: running-replications.adoc
:authentication-certs: authentication-certs.adoc
...
:authentication-users-xref: {xref-pfx-sgw}{authentication-users}[User Authentication]
...
:authentication-certs-xref: {xref-pfx-sgw}{authentication-certs}[TLS Certificate Authentication]
