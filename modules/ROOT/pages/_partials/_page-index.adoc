...
:configuration-properties--xref: {configuration-properties--pfx}[Legacy Pre-3.0 BETA Configuration]

// :configuration-properties--xref-use_tls_sever: {configuration-properties--pfx}#use_tls_sever[use_tls_sever]
:configuration-properties--xref-disable-persistent-config: {configuration-properties--pfx}#disable_persistent_config[disable-persistent-config]
// :configuration-properties--xref-admin_interface_authentication: {configuration-properties--pfx}#admin_interface_authentication
// :configuration-properties--xref-metrics_interface_authentication: {configuration-properties--pfx}#metrics_interface_authentication
...
:configuration-properties--xref--schema: {configuration-properties--pfx}#configuration-reference[Configuration]
...
:rest-api-admin--xref--database-configuration: {rest-api-admin--pfx}#/Database_Configuration[Database Configuration]
...
:rest-api-admin--xref--import-filter: {rest-api-admin--pfx}#/Import_Filter[Import Filter]
