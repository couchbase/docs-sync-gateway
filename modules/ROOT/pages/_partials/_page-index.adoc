...
:sgw-pg-resolving-conflicts-pre-2-0: resolving-conflicts.adoc
...
:xref-sgw-pg-resolving-conflicts-pre-2-0: {xref-pfx-sgw}{sgw-pg-resolving-conflicts-pre-2-0}[Conflict Resolution (pre 2.0)]
