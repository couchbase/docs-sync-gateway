...
:configuration-schema-db-security--xref: {sgw--xref}{configuration-schema-db-security--page}[Database Security Configuration Schema]
...
:configuration-schema-import-filter--xref: {sgw--xref}{configuration-schema-import-filter--page}[Import Filter Configuration Schema]
