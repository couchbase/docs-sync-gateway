...
:server-security-auth-domains--pfx: {svr--xref}{server-security--page}
:server-security-auth-domains--xref: {svr--xref}{server-security-auth-domains--page}[Couchbase Server - Authentication Domains]
