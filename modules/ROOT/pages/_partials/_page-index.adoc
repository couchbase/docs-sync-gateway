...
:xref-sgw-pg-icr-sgreplicate-sgr1: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr1}[SG Replicate]
:xref-sgw-pg-icr-sgreplicate-sgr2: {xref-sgw-pfx-icr-sgreplicate}[inter-Sync Gateway Replication with Sync Gateway 2.8+]
...
// [SGCollect Info]
:xref-sgw-pg-shared-bucket-access: {xref-pfx-sgw}{sgw-pg-shared-bucket-access}[Mobile-Server Replication]
