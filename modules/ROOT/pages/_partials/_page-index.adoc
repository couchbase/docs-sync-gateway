...
:bootstrap-schema--xref--api-https-tls-cert-path: {bootstrap-schema--pfx}#api-https-tls_cert_path[api.https.tls_cert_path]
:bootstrap-schema--xref--api-https-tls-key-path: {bootstrap-schema--pfx}#api-https-tls_key_path[api.https.tls_key_path]
:bootstrap-schema--xref--api-https-tls-minimum-version: {bootstrap-schema--pfx}#api-https-tls_minimum_version[api.https.tls_minimum_version]
...
:bootstrap-schema--xref--api: {bootstrap-schema--pfx}#api[bootstrap.api]
