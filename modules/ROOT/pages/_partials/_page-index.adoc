...
:xref-sgw-pg-gs-sgw-config: {xref-pfx-sgw}{sgw-pg-gs-sgw-config}[Configure Sync Gateway]
:xref-sgw-pg-gs-sgw-install: {xref-pfx-sgw}{sgw-pg-gs-sgw-install}[Install Sync Gateway]
