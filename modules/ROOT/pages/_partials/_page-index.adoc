...
:configuration-schema-static--xref--databases-sgr-ws-heartbeat: {configuration-schema-static--pfx--db}-this_db-sgreplicate_websocket_heartbeat_secs
...
:configuration-schema-static--xref--databases-user-admin-channels: {configuration-schema-static--pfx--db}-this_db-users-this_user-admin_channels[user admin_channels]
