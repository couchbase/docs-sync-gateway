...
:xref-sgw-pg-command-line-options: {xref-pfx-sgw}{sgw-pg-command-line-options}[Use Command Line Configuration]
...
:xref-sgw-pg-config-properties: {xref-sgw-pfx-config-properties}[Configuration Details]
...
:xref-sgw-pg-config-properties-databases-delta-sync: {xref-sgw-pfx-config-properties-db}-this_db-delta_sync[delta_sync]
...
:xref-sgw-pg-config-properties-db-rep-state: {xref-sgw-pfx-config-properties-db-rep}state[state]
...
:xref-sgw-pg-icr-conflict-resolution: {xref-sgw-pfx-icr-conflict-resolution}[Conflicts in Inter-sync-gateway replication]
...
:xref-sgw-pg-icr-monitoring: {xref-sgw-pfx-icr-monitoring}[Monitoring Inter-sync-gateway replications]
...
:xref-sgw-pg-icr-sgreplicate-sgr1: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr1}[Inter-sync-gateway replication vn:1]
:xref-sgw-pg-icr-sgreplicate-sgr2: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr2}[Inter-sync-gateway Replication vn:2]
// :xref-sgw-pg-icr-overview: {xref-pfx-sgw}{sgw-pg-icr-overview}[Inter-sync-gateway Replication]
:xref-sgw-pfx-icr-overview: {xref-sgw-pg-icr-sgreplicate}
:xref-sgw-pg-icr-overview: {xref-sgw-pfx-icr-overview}[Inter-sync-gateway Replication]
...
:xref-sgw-pg-icr-overview--intro: {xref-pfx-sgw}{sgw-pg-icr-overview}#introduction[Introducing Inter-sync-gateway Replication]
...
:xref-sgw-pg-security: {xref-pfx-sgw}{sgw-pg-security}[Security Best Practices]
...
// [SGCollect Info]
:xref-sgw-pg-shared-bucket-access: {xref-pfx-sgw}{sgw-pg-shared-bucket-access}[Mobile-Server Replication Concept]
:xref-sgw-pg-stats-monitoring: {xref-pfx-sgw}{sgw-pg-stats-monitoring}[View Statistics and Metrics]
// [Stats and Monitoring?]
:xref-sgw-pg-supported-os: {xref-pfx-sgw}{sgw-pg-supported-os}[Supported OS]
:xref-sgw-pg-def-sync-function: {xref-pfx-sgw}{sgw-pg-def-sync-function}[Defining Sync Functions]
:xref-sgw-pfx-sync-gateway-channels: {xref-pfx-sgw}{sgw-pg-sync-gateway-channels}
:xref-sgw-pg-sync-gateway-channels: {xref-sgw-pfx-sync-gateway-channels}[Sync Gateway Channels]
:xref-sgw-pg-sync-gateway-channels-add: {xref-sgw-pfx-sync-gateway-channels}#add-to-channel[Sync Gateway Channels -- add to channel]
:xref-sgw-pg-upgrade: {xref-pfx-sgw}{sgw-pg-upgrade}[Notes on Upgrading]
