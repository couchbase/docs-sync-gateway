...
:server-collections--xref: {svr--xref}{server-collections--page}[Couchbase Collections]
:server-collections-default--xref: {svr--xref}{server-collections--page}#default-scope-and-collection[Default Collections]
:server-collections-named--xref: {svr--xref}{server-collections--page}#naming-for-scopes-and-collections[Named Collections]
