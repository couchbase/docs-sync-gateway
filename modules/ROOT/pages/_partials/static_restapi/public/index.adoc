...
:keywords: openapi, rest, Sync Gateway Public REST API
:specDir: 
:snippetDir: 
:generator-template: v1 2019-12-20 (+ SimonD + HakimC changes)
:info-url: https://openapi-generator.tech
:app-name: Sync Gateway Public REST API

[abstract]
.Abstract
# Introduction  Sync Gateway manages access and synchronization between Couchbase Lite and Couchbase Server. The Sync Gateway Public REST API is used for client replication.
...
* xref:#+post_db-_ensure_full_commit+[Ensure Full Commit]
...
:desc-DatabaseState: The state of the database.
...
* xref:#+DatabaseState+[DatabaseState]
...
// markup not found, no include::{specDir}definitions/DatabaseState/definition-before.adoc[opts=optional]
...
// markup not found, no include::{specDir}definitions/DatabaseState/definition-begin.adoc[opts=optional]


[#fields-DatabaseState]
[cols="1,4,1"]
|===
| Name| Description| Schema
...
// markup not found, no include::{specDir}definitions/DatabaseState/definition-end.adoc[opts=optional]



// markup not found, no include::{specDir}definitions/DatabaseState/definition-after.adoc[opts=optional]
