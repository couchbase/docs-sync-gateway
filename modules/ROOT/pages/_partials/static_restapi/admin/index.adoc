...
| xref:#++PostKeyspacePurgeRequest++[+PostKeyspacePurgeRequest+]
...
:desc-AuditEventVerbose: Detailed information about an audit event.
...
:desc-Database-audit: A map of audit events and whether they are enabled or not.
:desc-Database-audit-verbose: A map of detailed audit events.
...
:desc-Database_config_logging: Per-database logging configuration.
:desc-Database_config_logging_audit: Audit logging configuration.
:desc-Database_config_logging_console: Console logging configuration.
...
:desc-Database_config_roles_value: Properties associated with a role
...
:desc-Database_config_users_value: Properties associated with a user
...
:desc-Simple_1: A map of audit events and whether they are enabled or not.
...
:desc-Startup_config_bucket_credentials_value: The configuration for the credentials set.
...
:desc-Verbose_1: A map of detailed audit events.
:desc-Verbose_allOf_events_value: The audit event ID and whether it is enabled or not.
...
* xref:#+AuditEventVerbose+[audit-event-verbose]
* xref:#+Audit_logging_config+[Audit-logging-config]
* xref:#+Audit-User-Roles+[AuditUserRoles]
...
* xref:#+Console_logging_config_rotation+[ConsoleLoggingConfigRotation]
* xref:#+CredentialsConfig+[Credentials config]
* xref:#+Database+[Database-config]
* xref:#+Database-audit+[Simple]
* xref:#+Database-audit-verbose+[Verbose]
...
* xref:#+Database_config_logging_audit+[DatabaseConfigLoggingAudit]
* xref:#+Database_config_logging_audit_disabled_roles_inner+[DatabaseConfigLoggingAuditDisabledRolesInner]
* xref:#+Database_config_logging_audit_disabled_users_inner+[DatabaseConfigLoggingAuditDisabledUsersInner]
...
* xref:#+Database_config_roles_value+[Role]
...
* xref:#+Database_config_users_value+[User]
* xref:#+Database-Get-Audit+[Simple]
* xref:#+Database-Get-Audit-Verbose+[Verbose]
...
* xref:#+get_db__config_audit_200_response+[GetDbConfigAudit200Response]
...
* xref:#+put_db__config_audit_request+[PutDbConfigAuditRequest]
...
* xref:#+Startup_config_bucket_credentials_value+[Credentials config]
...
* xref:#+Verbose+[Verbose]
* xref:#+Verbose_1+[Verbose]
* xref:#+Verbose_allOf_events_value+[audit-event-verbose]
...
a| *+send_www_authenticate_header+* +
_optional_
...
_optional_
a|
ifdef::desc-Database_config_logging[]
{desc-Database_config_logging}
endif::[]
...
// end
| xref:#++Database_config_logging++[+Database_config_logging+]
...
a| *+require_resync+* +
_optional_
a| Indicates whether the database requires resync before it can be brought online.
...
a| *+init_in_progress+* +
_optional_
a| Indicates whether database initialization is in progress.
...
a| *+collections_processing+* +
_optional_
a| The collections that the resync operation is running on.

[%hardbreaks]
ifeval::["null" != "null"]
*Default:* `null`
endif::[]
ifeval::["{"scopeName":{"collection1":null,"collection2":null}}" != "null"]
...
_optional_
a|
ifdef::desc-Runtime_config_logging[]
{desc-Runtime_config_logging}
endif::[]
...
// end
| xref:#++Runtime_config_logging++[+Runtime_config_logging+]
...
_optional_
a|
ifdef::desc-Startup_config_logging_error[]
{desc-Startup_config_logging_error}
endif::[]
...
// end
| xref:#++Startup_config_logging_error++[+Startup_config_logging_error+]


a| *+warn+* +
_optional_
a|
ifdef::desc-Startup_config_logging_warn[]
{desc-Startup_config_logging_warn}
endif::[]
...
// end
| xref:#++Startup_config_logging_warn++[+Startup_config_logging_warn+]


a| *+info+* +
_optional_
a|
ifdef::desc-Startup_config_logging_info[]
{desc-Startup_config_logging_info}
endif::[]
...
// end
| xref:#++Startup_config_logging_info++[+Startup_config_logging_info+]


a| *+debug+* +
_optional_
a|
ifdef::desc-Startup_config_logging_debug[]
{desc-Startup_config_logging_debug}
endif::[]
...
// end
| xref:#++Startup_config_logging_debug++[+Startup_config_logging_debug+]
...
_optional_
a|
ifdef::desc-Startup_config_logging_stats[]
{desc-Startup_config_logging_stats}
endif::[]
...
// end
| xref:#++Startup_config_logging_stats++[+Startup_config_logging_stats+]


a| *+audit+* +
_optional_
a|
ifdef::desc-Audit_logging_config[]
{desc-Audit_logging_config}
endif::[]
...
// end
| xref:#++Audit_logging_config++[+Audit_logging_config+]
...
// markup not found, no include::{specDir}definitions/Simple_1/definition-before.adoc[opts=optional]
