...
Versions of inter-Sync Gateway replications introduced in 2.8 and the previous version with SG Replicate can legitimately be in use at the same time, especially during transition.
However, you should avoid initializing identical replications using version introduced in 2.8 and pre-2.8 version with SG Replicate.
