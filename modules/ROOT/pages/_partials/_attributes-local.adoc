...
:url-cb-blog: https://blog.couchbase.com/category/couchbase-mobile/?ref=blog-menu
...
:fn_legacy: footnote:fnlegacy[For Pre-3.0 legacy configuration see: xref:configuration-properties-legacy.adoc[Configuration Pproperties (legacy Pre3.0)]
