...
Description::
The total number of bytes received (since node start-up) on the network interface to which the Sync Gateway {configuration-properties--pfx}#adminInterface[admin interface] is bound.
+
...
Description::
The total number of bytes sent (since node start-up) on the network interface to which the Sync Gateway {configuration-properties--pfx}#adminInterface[admin interface] is bound.
+
...
==== pub_net_bytes_recv
Description::
The total number of bytes received (since node start-up) on the network interface to which the Sync Gateway {configuration-properties--pfx}#interface[public interface] is bound.
+
...
==== pub_net_bytes_sent
Description::
The total number of bytes sent (since node start-up) on the network interface to which Sync Gateway {configuration-properties--pfx}#interface[public interface] is bound.
+
