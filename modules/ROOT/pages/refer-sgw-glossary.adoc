...
Optional feature in Couchbase Lite 2.x
...
It is an optional feature in xref:couchbase-lite:ROOT:swift.adoc#handling-conflicts[Couchbase Lite 2.0 and above] and xref:config-properties.adoc#databases-foo_db-allow_conflicts[Sync Gateway 2.0 and above].
