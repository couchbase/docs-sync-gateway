...
The diagram below describes this architecture.
...
=== How do I query for all documents in a channel with N1QL?
...
Attachments can be accessed through Sync Gateway's REST API using the xref:rest-api.adoc#/attachment/get\__db___doc___attachment_[/{db}/{doc}/{attchament}] endpoint.
