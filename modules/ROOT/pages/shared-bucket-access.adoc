...
Starting in Sync Gateway 1.5, mobile, web and desktop applications can write to the same bucket in a Couchbase cluster.
The following diagram shows the different components persisting to a single bucket.
