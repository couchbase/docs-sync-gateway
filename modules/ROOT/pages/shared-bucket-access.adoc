...
Shared Bucket Access enables document changes in a Couchbase Server bucket to be made through Couchbase SDKs, N1QL queries or Sync Gateway and vice versa.
