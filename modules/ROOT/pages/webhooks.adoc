...
== Definition
You can define _Webhooks_ in Sync Gateway's {configuration-schema-static--xref} at the database level.

include::partial$common-cfg-ext-javascript.adoc[tag=intro]

Learn more about this property ($db.event_handlers) in the Configuration Schema Reference -- see: {configuration-schema-static--xref--eventhandlers}.
...
+
--
Property name: {configuration-schema-static--xref--eventhandlers-doc-changed-filter}
...
Property name: {configuration-schema-static--xref--eventhandlers-doc-changed-handler}
+
--
...
+
--
Property name: {configuration-schema-static--xref--eventhandlers-doc-changed-timeout}
...
+
--
Property name: {configuration-schema-static--xref--eventhandlers-doc-changed-url}
...
+
--
Property name: {configuration-schema-static--xref--eventhandlers-max-processes}
...
+
--
Property name: {configuration-schema-static--xref--eventhandlers-wait-for-process}
