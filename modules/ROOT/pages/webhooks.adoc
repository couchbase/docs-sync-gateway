...
== Definition
Define _Webhooks_ in Sync Gateway's {xref-sgw-pg-config-properties} using the database level {xref-sgw-pg-config-eventhandlers} properties.
...
+
--
Property name: {xref-sgw-pg-config-eventhandlers-doc-changed-filter}
...
Property name: {xref-sgw-pg-config-eventhandlers-doc-changed-handler}
+
--
...
+
--
Property name: {xref-sgw-pg-config-eventhandlers-doc-changed-timeout}
...
+
--
Property name: {xref-sgw-pg-config-eventhandlers-doc-changed-url}
...
+
--
Property name: {xref-sgw-pg-config-eventhandlers-max-processes}
...
+
--
Property name: {xref-sgw-pg-config-eventhandlers-wait-for-process}
