...
// * set a color for log output based on log level if {xref-sgw-pfx-config-properties}#logging-console-color_enabled[`logging.console.color_enabled`] is set to `true`
// +
