...
xref:couchbase-lite:swift:learn/swift-replication.adoc#replication-events[Swift] | xref:couchbase-lite:java:learn/java-replication.adoc#replication-events[Java] |  xref:couchbase-lite:android:learn/java-android-replication.adoc#replication-events[Android (Java)] | xref:couchbase-lite:csharp:learn/csharp-replication.adoc#replication-events[C#] | xref:couchbase-lite:objc:objc-replication.adoc#replication-events[Objective-C]
