...
:description: Couchbase Sync Gateway -- Inter-Sync Gateway Replication provides resilient, secure, scalable bidirectional synchronization of data between cloud and edge data centers.
...
:param-abstract: This content describes Couchbase Sync Gateway's Inter-Sync Gateway Replication feature (v2). It incorporates the content presented under Manage within the Nav bar to give an integrated view.
