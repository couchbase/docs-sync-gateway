...
*However*, the inter-Sync{nbsp}Gateway replication feature is specifically designed for Sync Gateway deployments and it *must* be used for replication between clusters containing an {glos-term-active-sgnode}.
