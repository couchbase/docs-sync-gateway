...
----
The deployment controller will ensure that at least one replica is available to server the incoming requests while the other replicas are being upgraded.
