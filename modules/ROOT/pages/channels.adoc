...
You assign documents to channels by writing a Sync Function in the configuration file ({configuration-properties-pfx}#databases-this_db-sync[databases.$db.sync]).
