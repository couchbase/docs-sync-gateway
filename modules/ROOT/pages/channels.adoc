...
xref:couchbase-lite:swift:replication.adoc#replication-events[Swift] | xref:couchbase-lite:java:replication.adoc#replication-events[Java] |  xref:couchbase-lite:android:replication.adoc#replication-events[Android (Java)] | xref:couchbase-lite:csharp:replication.adoc#replication-events[C#] | xref:couchbase-lite:objc:replication.adoc#replication-events[Objective-C]
