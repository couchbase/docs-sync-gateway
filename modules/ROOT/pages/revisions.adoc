...
* xref:configuration-schema-database.adoc#cache-rev_cache-max_memory_count_mb[rev_cache.max_memory_count_mb]
...
You can use the xref:configuration-schema-database.adoc#cache-rev_cache-max_memory_count_mb[`rev_cache.max_memory_count_mb`] setting to specify the maximum amount of memory the revision cache should take up in MB.
