...
A user can be granted access to a channel through the {configuration-schema-static--pfx}#databases-this_db-users-this_user-admin_channels[admin_channels] property in the configuration file.
