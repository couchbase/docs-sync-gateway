...
This behavior is suitable for most apps that rely on {xref-sgw-pg-authentication} and the {xref-sgw-pg-sync-function} to specify which data to pull for each user.
