...
RBAC user authentication enables <<lbl-secure-users,Secure Remote Administration>> of {sgw} clusters.
...
You can choose to disable secure remote authentication by using these bootstrap configuration settings or CLI flags:
