...
{rest-api-admin--pfx}#/database/post\__db___offline[+/\{db}/_offline+]
. Resync the database +
Use this Admin REST API endpoint: +
{rest-api-admin--pfx}#/database/post\/post__db___resync[+/\{db}/_resync+]
+
The message body of the response contains the number of changes that were made as a result of calling resync
. Bring the database back online +
Use this Admin REST API endpoint: +
{rest-api-admin--pfx}#/database/post\__db___online[+/\{db}/_online+]
--
