...
:param-abstract: This content explains the re-sync feature
...
To this end, the Admin REST API provides a re-sync endpoint that enables you initiate the reprocessing of every document in the database again.

== Updating the Sync Function
To update the Sync Function and fully re-sync, you are recommended to follow the steps in <<steps-to-resync>>.
