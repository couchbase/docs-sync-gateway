...
* _Read More_: {xref-sgw-pg-icr-overview}
* _Related Config Elements_: {configuration-schema-database--pfxdb-rep-adhoc}  |  {configuration-schema-database--pfxdb-rep-continuous}
...
Configuration property: {configuration-schema-database--pfxdb-rep-resolver}
--
...
It is an optional feature in Couchbase Lite 2.0 and {configuration-properties-legacy--pfx}#databases-this_db-allow_conflicts[Sync Gateway 2.0 and above].
