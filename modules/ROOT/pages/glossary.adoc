...
* _Read More_: {xref-sgw-pg-icr-overview}
* _Related Config Elements_: {configuration-properties--xref--db-rep-adhoc}  |  {configuration-properties--xref--db-rep-continuous}
...
Configuration property: {configuration-properties--xref--db-rep-resolver}
--
