...
* _Read More_: {xref-sgw-pg-icr-overview}
* _Related Config Elements_: {configuration-schema-static--xref--db-rep-adhoc}  |  {configuration-schema-static--xref--db-rep-continuous}
...
Configuration property: {configuration-schema-static--xref--db-rep-resolver}
--
...
It is an optional feature in Couchbase Lite 2.0 and {configuration-schema-static--pfx}#databases-this_db-allow_conflicts[Sync Gateway 2.0 and above].
...
// tag::sgw-icr-sync-function-rel[]
 {configuration-schema-static--xref--databases}  |  {configuration-schema-static--xref--databases-sync}
...
* {configuration-schema-static--pfx}#databases-this_db-enable_shared_bucket_access[$dbname.enable_shared_bucket_access]
