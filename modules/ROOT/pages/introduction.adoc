...
[.full-width-tile]
TIP: For more information about the latest changes to Sync Gateway, see xref:ROOT:whatsnew.adoc[].
...
* xref:manage:channel-history.adoc[]
