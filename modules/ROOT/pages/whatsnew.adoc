...
== Diagnostic API Enhancements

*Dry-run execution for Sync Functions and Import Filters*
The Diagnostic API now supports dry-run execution of Sync Functions and Import Filters with inline function source and log capture, enabling safe validation and faster troubleshooting.
