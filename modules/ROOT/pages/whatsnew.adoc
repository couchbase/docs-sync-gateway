...
Couchbase Mobile's cloud-to-edge support for xref:couchbase-lite:ROOT:pages/_partials/commons/common-scopes-collections-management.adoc[scopes and collections] allows application developers to organize and logically isolate data.  
