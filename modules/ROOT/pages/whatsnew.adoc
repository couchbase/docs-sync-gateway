...
:xref-sgw-bmk-cfg-dbsvr: xref:{configuration-schema-static--page}#databases-this_db-server[Couchbase Server Connection String]
:xref-sgw-bmk-cfg-hideprodvn: xref:{configuration-schema-static--page}#hide_product_version[Hide Product Version in Headers]
