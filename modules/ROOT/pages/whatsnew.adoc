...
For more information on the benefits and examples of use cases, click https://www.couchbase.com/blog/scopes-collections-couchbase-mobile/[here].
...
Each database can only have one Scope, which lets users be associated with a Scope and shared across multiple Collections.
