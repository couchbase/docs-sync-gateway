...
:param-abstract: This content covers the new features introduced in Sync Gateway {release} {prerelease}

:param-related: {xref-sgw-pg-release-notes}
include::partial$block-abstract.adoc[]

NOTE: {sgw-t} {release} {prerelease} introduces some breaking changes. +
If you are upgrading from 2.x, please refer {upgrade--xref} page.

== Overview of {sgw-t} {release} {prerelease}
