...
Couchbase Mobile's cloud-to-edge support for xref:couchbase-lite:java:scopes-collections-manage.adoc[Scopes and Collections] allows application developers to organize and logically isolate data.  
