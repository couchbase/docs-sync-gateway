...
This occurs during a mixed installation consisting of a sync Gateway 3.2 version and an earlier version and you deploy a new Eventing/Sync Gateway function during an upgrade.
