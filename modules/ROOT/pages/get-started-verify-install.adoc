...
<.> The username of the RBAC user that you created on the Couchbase Server Admin Console -- see xref:{get-started-prepare-page}}#configure-server[Configure Server for Sync Gateway]
