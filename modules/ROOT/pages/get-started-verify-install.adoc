...
<.> Here we point to the Couchbase Server cluster
...
<.> Here we allow non-TLS plaintext access to the Couchbase Server for test purposes
...
----
bin/sync_gateway -bootstrap.use_tls_server=false sgwconfig.json // <.>
----
<.> use CLI flag to signal non-TLS communications
...
====
----
curl --location --request PUT 'http://127.0.0.1:4985/travel25/_role/stdrole' \ // <.>
--header 'Authorization: Basic c3luY19nYXRld2F5OnBhc3N3b3Jk' \
--header 'Content-Type: application/json' \
--data-raw '{
    "name": "stdrole",
...
====
----
curl --location --request PUT 'http://127.0.0.1:4985/travel25/_user/sgwuser1' \ // <.>
--header 'Authorization: Basic c3luY19nYXRld2F5OnBhc3N3b3Jk' \
--header 'Content-Type: application/json' \
--data-raw '{
    "name": "sgwuser1", //
...
[{snippet-header}]
----
curl --location --request PUT 'http://localhost:4985/travel25/hotel_88801' \
...
[{snippet-header}]
----
curl --location --request GET 'http://localhost:4985/travel25/hotel_88801' \
--header 'Authorization: Basic c3luY19nYXRld2F5OnBhc3N3b3Jk'
----
...
[{snippet-header}]
----
curl --location -g --request PUT 'http://localhost:4985/travel25/hotel_88801?new_edits=true&rev=1-f28b5cc13a38892f4f85913d4e654270' \  // <.>
...
[{snippet-header}]
----
curl --location -g --request DELETE 'http://localhost:4985/travel25/88801?rev=3-cc2e758ef63b0daf5b01b2baf98c72b6' // <.>
----
