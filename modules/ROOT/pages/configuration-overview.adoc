...
You can disable it, for testing purposes *ONLY*, by providing null values for the {bootstrap-schema--xref--tls-cert-path} and {bootstrap-schema--xref--tls-key-path}.
