...
// This xref doesn't exist in couchbase-lite link:../../couchbase-lite/native-api/document/index.html#document-expiration-ttl[Document] guide; it redirects to the link below
...
// This xref doesn't exist in couchbase-lite link:../../couchbase-lite/native-api/database/index.html#database-notifications[Database Change Notifications]; it redirects to the link below
...
Alternatively you can download standalone Curl for Windows: http://curl.haxx.se/download.html.
