...
Provide a better way of linking the Couchbase Lite and Sync Gateway  (for instance link to getting started or replicator config section on Couchbase Lite" .
