...
Sync Gateway provides a turn-key solution to authenticate with Facebook and Google.
...
- xref:rest-api.adoc#/auth/post\_\_db\_\_\_facebook[+/{db}/_facebook+]
- xref:rest-api.adoc#/auth/post__db___facebook[+/{db}/_google+]
