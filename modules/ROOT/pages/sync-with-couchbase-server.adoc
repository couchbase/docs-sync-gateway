...
// * xref:couchbase-lite:swift:blob.adoc[Swift]
// * xref:couchbase-lite:objc:blob.adoc[Objective-C]
// * xref:couchbase-lite:java:blob.adoc[Java]
// * xref:couchbase-lite:android:blob.adoc[Android (Java)]
// * xref:couchbase-lite:csharp:blob.adoc[C#]
