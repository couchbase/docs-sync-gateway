...
* A user requests data that doesn't reside in the xref:config-properties.adoc#1.5/databases-foo_db-cache-channel_cache_max_length[channel cache].
...
* Upgrade Couchbase Server using any of the options mentioned in the xref:5.5@server:install:upgrading.adoc[Upgrading Couchbase Server] documentation.
