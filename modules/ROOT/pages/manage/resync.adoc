...
:resync_api_post: xref:rest_api_admin.adoc#tag/Database-Management/operation/post_db-_resync[POST /{db}/_resync]
:resync_api_get: xref:rest_api_admin.adoc#tag/Database-Management/operation/get_db-_resync[GET /{db}/_resync]
...
Be sure to take the database offline using xref:rest_api_admin.adoc#tag/Database-Management/operation/post_db-_offline[+/{db}/_offline+].
...
To ensure this happens, you must taken all instances offline using the xref:rest_api_admin.adoc#tag/Database-Management/operation/post_db-_offline[+/{db}/_offline+] endpoint.
