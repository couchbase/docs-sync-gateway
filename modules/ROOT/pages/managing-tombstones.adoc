...
a|
* Restarting Sync Gateway will flush the cache.
* Starting in 2.1.1, running the {rest-api-admin--pfx}#/database/post\__db___compact[+/\{db}/_compact+] endpoint will remove purged tombstones from the channel cache.
