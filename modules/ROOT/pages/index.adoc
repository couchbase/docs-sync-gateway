...
For more information about platform support changes, deprecation notifications, notable improvements, and fixed and known issues, refer to the xref:release-notes.adoc[Release Notes].
...
Find out more in the xref:release-notes.adoc#major[Release Notes] |
xref:release-notes.adoc#latest[Latest maintenance release notes]
