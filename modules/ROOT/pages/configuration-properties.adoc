...
// END -- DO NOT EDIT
CAUTION: This page describes Sync Gateway's legacy Pre-3.0 BETA configuration method -- for current configuration details -- see: {configuration-overview--xref} and-or {configuration-schema-bootstrap--xref}.
