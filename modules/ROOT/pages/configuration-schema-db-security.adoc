...
=======
include::partial$static_restapi/admin/index.adoc[tags=put_db-_role-name,leveloffset=+1]
...
<.> Use Basic Auth to authenticate to an existing RBAC user
>>>>>>> release/3.3
...
include::partial$static_restapi/admin/index.adoc[tags=put_db-_user-name,leveloffset=+1]
