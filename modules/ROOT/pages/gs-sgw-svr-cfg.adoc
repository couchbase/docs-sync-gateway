...
+
The steps to do thia differ depending on Couchbase Server version deployed. See below:
+
.Select RBAC roles
=====
[{tabs}]
...
+
xref:server:modules:learn/pages/security/roles.adoc#sync-gateway[Sync Gateway RBAC Role Description]
+
image::user-settings-6-6.png[,300]
...
** Read Only Admin
+
image::user-settings-5-5.png[,300]
--
