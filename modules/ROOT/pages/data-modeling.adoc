...
* A history of past revision IDs (linear in Sync Gateway 4.x+ due to automatic conflict resolution, may branch in versions earlier than 4.x when conflicts occurred)
