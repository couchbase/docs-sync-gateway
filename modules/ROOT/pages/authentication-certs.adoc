...
:param-related:  {xref-sgw-pg-authentication}  |  {xref-sgw-pg-def-sync-function}  |  {xref-sgw-pg-adv-sgw-cfg-import-filter}  |  {xref-sgw-pg-read-access}  |  {xref-sgw-pg-write-access}
...
If Sync Gateway is deployed on an internal network, you can bind the {xref-sgw-pfx-config-properties}#server[adminInterface] of Sync Gateway to the internal network.
In this case, the firewall should also be configured to allow external connections to the public {xref-sgw-pfx-config-properties}#server[interface] port.
...
* {xref-sgw-pfx-config-properties}#databases-this_db-certpath[databases.$db.certpath]
* {xref-sgw-pfx-config-properties}#databases-this_db-keypath[databases.$db.keypath]
* {xref-sgw-pfx-config-properties}#databases-this_db-cacertpath[databases.$db.cacertpath]
