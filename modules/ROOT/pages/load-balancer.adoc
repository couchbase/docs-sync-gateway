...
In particular, when using NGINX or AWS Elastic Load Balancer (ELB). For an architectural walkthrough, you can refer to the
//link doesn't exist link:../../../training/deploy/install/index.html[Deploy], redirects to link below:
