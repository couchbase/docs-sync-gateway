...
* This typically occurs when you deploy the same Eventing function on both the source and target clusters.
...
A simple way to avoid loops is to check whether the document has already been enriched.
