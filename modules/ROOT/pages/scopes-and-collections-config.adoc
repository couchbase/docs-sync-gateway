...
Please be aware that only Couchbase Server (CBS) allows using the word `_default` in naming conventions. 
This explains why you may see the term `_default._default` when creating a new bucket. 
