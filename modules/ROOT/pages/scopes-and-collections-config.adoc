...
You can define 1 custom scope per database with up to 1000 custom collections in release 3.1. +
...
You can choose the default scope with up to 1000 custom collections in release 3.1.

Scopes and Collections are optional. 
Default scopes and collections will be applied automatically if non are specified.

* *default scope/default collection* +
You can choose the default scope with default collections in release 3.1.
