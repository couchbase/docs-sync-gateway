= Log Rotation
:description: This log rotation content was deprecated in Sync Gateway.1 and applies only to pre-2.1 versions.
:page-aliases: learn/logging-legacy-pre2-1.adoc
...
The descriptions and default values for each logging property can be found on the xref:{configuration-properties-legacy--page}[Sync Gateway configuration] page.
...
The *logFilePath* property can also be set in the configuration file at the {configuration-properties-legacy--pfx}#server-configuration[server level].
