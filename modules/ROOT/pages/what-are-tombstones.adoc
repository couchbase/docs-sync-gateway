= Tombstones
:page-aliases: learn/concept-tombstones.adoc, learn/concept-fundamentals-data-tombstones.adoc, learn/what-are-tombstones.adoc
:page-layout: article
:page-content: conceptual
:description: pass:q[About Sync Gateway _Tombstones_.]
...
:param-related: {channels--xref}  |  {revisions--xref}  |  {roles--xref}  |  {users--xref}
