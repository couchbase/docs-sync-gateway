...
* xref:couchbase-lite:android:learn/java-android-conflict.adoc[Android (Java)]
* xref:couchbase-lite:csharp:learn/csharp-conflict.adoc[C#]

For conflict resolution on devices using versions prior to 2.0 -- see: {xref-sgw-pg-resolving-conflicts}
