...
`sgcollect_info` can now be run from the Admin REST API as of Sync Gateway 2.1 using the xref:admin-rest-api.adoc#?v=2.1#/server/post__sgcollect_info[/_sgcollect_info] endpoint.
