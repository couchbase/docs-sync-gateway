...
`sgcollect_info` can now be run from the Admin REST API as of Sync Gateway 2.1 using the {rest-api-admin--pfx}#/server/post__sgcollect_info[_sgcollect_info] endpoint.
