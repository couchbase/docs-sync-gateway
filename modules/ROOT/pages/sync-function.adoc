...
- xref:write-security.adoc#data-validation[Validate the document]
- xref:write-security.adoc#write-access[Authorize the change]
- xref:data-routing.adoc#add-to-channel[Assign the document to channels]
