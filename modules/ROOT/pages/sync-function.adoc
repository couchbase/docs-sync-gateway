...
:param-related: {configuration-properties-xref}  |  {rest-api-admin-xref} |    {configuration-properties-xref--databases}  |  {configuration-properties-xref--databases-sync}
...
You can learn more about this property ($db.sync) in the Configuration Schema Reference -- see: {configuration-properties-xref--databases-sync}.
