...
:topic-group: Deploy
:param-related: {xref-sgw-pg-deployment}  |  {rest-api-access--xref}  |  {configuration-properties-legacy--xref}
...
* {configuration-properties-legacy--pfx}#databases-this_db-use_views[`databases.$db.use_views`]
* {configuration-properties-legacy--pfx}#databases-this_db-num_index_replicas[`databases.$db.num_index_replicas`]
