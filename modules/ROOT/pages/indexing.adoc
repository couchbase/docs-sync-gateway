...
* {configuration-schema-static--pfx}#databases-this_db-use_views[`databases.$db.use_views`]
* {configuration-schema-static--pfx}#databases-this_db-num_index_replicas[`databases.$db.num_index_replicas`]
