...
:topic-group: Deploy
:param-related: {xref-sgw-pg-deployment}  |  {get-started-access-rest-api--xref}  |  {configuration-properties--xref}
...
* {configuration-properties-pfx}#databases-this_db-use_views[`databases.$db.use_views`]
* {configuration-properties-pfx}#databases-this_db-num_index_replicas[`databases.$db.num_index_replicas`]
