...
== Overview
Sync Gateway uses GSI and {sqlpp} to perform a variety of internal operations, including authentication and replication.
...
You can continue to define views through the xref:rest_api_admin.adoc#tag/Unsupported[Sync Gateway Admin REST API].
