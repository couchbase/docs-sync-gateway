...
:tabs:
:sg_download_link: http://packages.couchbase.com/releases/couchbase-sync-gateway/1.5.1/
:sg_package_name: couchbase-sync-gateway-community_1.5.1_x86_64
:sg_accel_package_name: couchbase-sg-accel-enterprise_1.5.1_x86_64
