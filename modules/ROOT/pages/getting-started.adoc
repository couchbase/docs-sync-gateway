...
:sg_download_link: http://packages.couchbase.com/releases/couchbase-sync-gateway/{patch-version}/
:sg_package_name: couchbase-sync-gateway-community_{patch-version}_x86_64
:sg_package_name_ee: couchbase-sync-gateway-enterprise_{patch-version}_x86_64
:sg_accel_package_name: couchbase-sync-gateway-enterprise_{patch-version}_x86_64
:tabs:
