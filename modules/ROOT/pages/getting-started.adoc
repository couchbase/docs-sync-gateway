...
:sg_download_link: http://packages.couchbase.com/releases/couchbase-sync-gateway/2.5.0/
:sg_package_name: couchbase-sync-gateway-community_2.5.0_x86_64
:sg_package_name_ee: couchbase-sync-gateway-enterprise_2.5.0_x86_64
:sg_accel_package_name: couchbase-sync-gateway-enterprise_2.5.0_x86_64
:tabs:
