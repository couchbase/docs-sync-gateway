...
:sg_download_link: http://packages.couchbase.com/releases/couchbase-sync-gateway/2.1.3/
:sg_package_name: couchbase-sync-gateway-community_2.1.3_x86_64
:sg_accel_package_name: couchbase-sync-gateway-enterprise_2.1.3_x86_64
:tabs:
...
Then select RBAC roles for the user.
+
