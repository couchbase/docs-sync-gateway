...
:sgw-pg-gs-server-cfg--lbl-create-rbac-user: {sgw-pg-gs-server-cfg}#step-2lbl-create-rbac-user
...
:xref-sgw-pg-gs-server-cfg--lbl-create-rbac-user: {xref-pfx-sgw}{sgw-pg-gs-server-cfg--lbl-create-rbac-user}[Create an RBAC User, {window-new}]
...
* If you are using RBAC users to connect, you need to create the sync gateway user as shown in {xref-sgw-pg-gs-server-cfg--lbl-create-rbac-user}.
+
