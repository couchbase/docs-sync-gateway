...
Number of bytes received on the admin interface.

Throughput on admin interface = `admin_net_bytes_recv` / `admin_net_bytes_sent`

===== admin_net_bytes_sent

Number of bytes sent on the admin interface.
...
Number of bytes received on the public interface.

Throughput on public interface = `pub_net_bytes_recv` / `pub_net_bytes_sent`

===== pub_net_bytes_sent

Number of bytes sent on the public interface.
