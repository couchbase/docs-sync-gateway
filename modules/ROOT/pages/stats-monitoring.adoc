...
Gauge representing the number of active replications, be it continuous or one shot.
This stat is identical to `num_pull_repl_active_one_shot`.

===== num_pull_repl_active_one_shot

Gauge representing the number of active replications, be it continuous or one shot.
This stat is identical to `num_pull_repl_active_continuous`.

===== num_pull_repl_total_continuous

Gauge representing number of active, idle, and stopped replications, be it continuous or one shot.
This stat is identical to `num_pull_repl_total_one_shot`.

===== num_pull_repl_total_one_shot

Gauge representing the number of active, idle, and stopped replications, be it continuous or one shot.
This stat is identical to `num_pull_repl_total_continuous`.
