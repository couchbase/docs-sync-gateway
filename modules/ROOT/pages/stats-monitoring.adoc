...
:param-related: {xref-sgw-pg-config-properties} | {xref-sgw-pg-rest-api-metrics}  | {xref-sgw-pg-stats-prometheus}
...
.Constraints
NOTE: The Mettrics REST API is OFF by default -- see {xref-sgw-pg-rest-api-metrics} for details on how to activate it.
