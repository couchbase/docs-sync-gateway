...
:page-layout: article
:page-partial:
:description: pass:q[Implement effective data routing and access control in the cloud-to-edge synchronization of enterprise data.]
:idprefix:
:idseparator: -
...
// }
// ----
// <1> {configuration-schema-static--pfx}#databases-this_db-users-this_user-admin_roles[databases.$db.users.$user.admin_roles]
