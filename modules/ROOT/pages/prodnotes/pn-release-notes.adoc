...
// include::learn/icr-sgreplicate.adoc[tag=intro]
...
Changes to the Sync Gateway configuration schema include:

include::partial$config-changes.adoc[tag=2-8-0-structuralonly,leveloffset=2]
