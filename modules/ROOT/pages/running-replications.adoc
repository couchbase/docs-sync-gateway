...
The list of returned stats and their meaning can be found on the API reference of the xref:admin-rest-api.adoc#/server/get__active_tasks[`_active_tasks`] endpoint.
