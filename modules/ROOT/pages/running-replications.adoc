...
The list of returned stats and their meaning can be found on the API reference of the link:admin-rest-api.html#/server/get\__active_tasks[`_active_tasks`] endpoint.
