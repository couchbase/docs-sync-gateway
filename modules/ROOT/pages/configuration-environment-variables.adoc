...
Insert the required environment variable references in a {configuration-schema-bootstrap--xref}, or in a {configuration-properties--xref} with `disable_persistent_config=true`.
