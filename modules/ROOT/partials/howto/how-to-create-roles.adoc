...
+
Configure roles in the xref:configuration:configuration-properties-legacy.adoc[Legacy Configuration Properties] file.
...
include::ROOT:partial$block-caveats.adoc[tags=disable-persistent-cinfig]
