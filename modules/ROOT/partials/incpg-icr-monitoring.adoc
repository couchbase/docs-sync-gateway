...
include::ROOT:partial$icr-replicationStatus-GET.adoc[tags=overview]


=== Retrieving Status Data for a Specific Replication

include::ROOT:partial$icr-replicationStatus-GET.adoc[tags=rep-status-specific]

=== Retrieving Status Data for All Replications

include::ROOT:partial$icr-replicationStatus-GET.adoc[tags=rep-status-all]
