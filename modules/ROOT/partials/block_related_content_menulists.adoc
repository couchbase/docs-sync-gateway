...
* xref:configuration:configuration-schema-isgr.adoc[Inter-Sync{nbsp}Gateway Replication]
...
// tag::concept-syncfunc[]
  * xref:configuration:configuration-schema-access-control.adoc[Access Control]
  * xref:rest-api:rest_api_admin.adoc#tag/Database-Configuration/operation/put_keyspace-_config-sync[Add/Update Sync Function]
  * xref:access-control:sync-function/sync-function.adoc[Sync Function Overview]
