...
include::ROOT:partial$block-caveats.adoc[tags=community-only-rep-same-node]
...
include::ROOT:partial$icr-replicationStatus-GET.adoc[tag=overview]
...
include::ROOT:partial$icr-replicationStatus-GET.adoc[tag=example-specific]
...
include::ROOT:partial$icr-replicationStatus-GET.adoc[tag=example-all]
