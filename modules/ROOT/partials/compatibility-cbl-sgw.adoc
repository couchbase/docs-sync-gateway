...
Connecting Couchbase Lite 4.0 to Sync Gateway versions before 4.0 is not supported. This is a known issue with fixes coming in Sync Gateway 3.2.7 and 3.3.1. This does not affect Sync Gateway 3.1 or earlier. Use Sync Gateway 4.0 for Couchbase Lite 4.0 compatibility.
====