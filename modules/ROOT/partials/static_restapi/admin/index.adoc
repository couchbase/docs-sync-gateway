...
//tag::Database_config_cors[]

ifdef::model-descriptions[]
//tag::desc-Database_config_cors[]
CORS configuration for this database; if present, overrides server's config.
//end::desc-Database_config_cors[]
endif::model-descriptions[]
