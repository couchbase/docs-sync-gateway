...
WARNING: If you are using xref:configuration:configuration-overview.adoc#lbl-config-grp[configuration groups] running on a different index configuration, calling xref:rest_api_admin_static.adoc#tag/Server/operation/post__post_upgrade[`POST /_post_upgrade`] can delete indexes out from under a running database.
