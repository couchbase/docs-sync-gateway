...
[NOTE]
====
The host-level instructions on this page apply to Sync Gateway installed directly on a host OS (for example, a bare-metal server or virtual machine).
For container environments (Docker, Kubernetes, or similar), see <<container-environments>>.
====
...
TIP: If you're using systemd, you can skip this section.
