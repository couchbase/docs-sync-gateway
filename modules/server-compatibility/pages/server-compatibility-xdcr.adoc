...
TIP: For detailed technical implementation and configuration requirements, see: xref:server:learn:clusters-and-availability/xdcr-active-active-sgw.adoc#xdcr-active-active-sgw-prerequisites[Bi-directional XDCR Active-Active with Mobile Clusters].
