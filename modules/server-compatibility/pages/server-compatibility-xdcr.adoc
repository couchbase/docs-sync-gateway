...
Couchbase Server's Cross Data Center Replication (xref:server:manage:manage-xdcr/xdcr-management-overview.adoc[XDCR]) replicates necessary Sync Gateway metadata along with associated documents, making it suitable for various mobile cluster replication scenarios.
