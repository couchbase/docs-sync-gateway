...
IMPORTANT: Sync Gateway 4.0 introduces native bi-directional XDCR support for active-active mobile clusters, providing a simpler and more efficient alternative to Inter-Sync Gateway Replication.
See <<lbl-bidirectional-xdcr>>.
