...
:page-aliases: ROOT:deploy-cluster.adoc, ROOT:advance/kubernetes/deploy-cluster.adoc, ROOT:deploy-cluster-to-kubernetes.adoc
...
:sgw-pg-gs-server-cfg: start-here:get-started-prepare.adoc
:sgw-pg-manage: {sgw-dir-k8s}manage-cluster.adoc
:sgw-pg-icr-replication: sync:sync-inter-syncgateway-run.adoc
...
include::ROOT:partial$block-related-content-k8s.adoc[]
