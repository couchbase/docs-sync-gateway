= JSON Metrics
:page-aliases: ROOT:stats-monitoring-json.adoc
...
NOTE: The statistics detailed in this schema are reset at each node restart -- they are not persisted.
All totals, counts, and averages are the values accrued since the last node restart unless otherwise specified.

TIP: Use the click-through links to find out more about each item.

[source,json,subs="normal, attributes"]
----
include::ROOT:partial$stats-schema.adoc[]
----

== Global stats

include::ROOT:partial$stats-schema-descriptions.adoc[]

== Alphabetic Index

.Quick Links
[sidebar]
<<symbol>> *|* <<A - C>> *|* <<D - G>> *|* <<H - N>> *|* <<P - Z>>
