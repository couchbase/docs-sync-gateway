= Tombstones
:page-aliases: ROOT:learn/concept-tombstones.adoc, ROOT:learn/concept-fundamentals-data-tombstones.adoc, ROOT:learn/what-are-tombstones.adoc, ROOT:what-are-tombstones.adoc, ROOT:managing-tombstones.adoc
...
.2+^.<| Couchbase Server
|Deleting a document body in the bucket (SDK, {sqlpp}, expiry)
|Removes the document and metadata
|Creates a tombstone
