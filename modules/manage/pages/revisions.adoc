...
This approach allows applications to use {configuration-schema-database--xref--revs-limit} values as low as 1 without affecting capabilities, though the default value remains 50.
