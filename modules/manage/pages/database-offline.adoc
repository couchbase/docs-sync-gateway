...
. Make a PUT request to xref:rest-api:rest_api_admin.adoc#tag/Database-Configuration/operation/post_db-_config[`/{db}/_config`] with `{"offline": true}`.
+
...
. Make a PUT request to xref:rest-api:rest_api_admin.adoc#tag/Database-Configuration/operation/post_db-_config[`/{db}/_config`] with `{"offline": false}`.
+
