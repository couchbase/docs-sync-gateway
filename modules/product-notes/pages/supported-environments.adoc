...
:page-aliases: official-support, supported-os, ROOT:prodnotes/pn-supported-os.adoc
...
include::ROOT:partial$sgw-supported-os.adoc[tag=supported]
...
include::ROOT:partial$sgw-supported-os.adoc[tags=deprecated]
