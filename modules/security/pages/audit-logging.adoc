= Audit Logging
:page-aliases: ROOT:audit-logging.adoc
...
IMPORTANT: xref:manage:sgcollect-info.adoc[SG Collect Info] does NOT collect audit log information as audit logs contain sensitive, unredacted data.
...
For more information, see xref:security:audit-log-events.adoc[audit events reference page].
...
See xref:security:audit-log-events.adoc[] for more information on specific audit events.
