...
image::ROOT:static-auth-provider.png[]

API reference:

- xref:rest-api:rest_api_public.adoc#tag/Authentication/operation/post_db-_facebook[/+{db}+/_facebook]
- xref:rest-api:rest_api_public.adoc#tag/Authentication/operation/post_db-_google[/+{db}+/_google]
...
image::ROOT:custom-auth-flow.png[]

Given a user that has already been created, a new session for that user can be created on the Admin xref:rest-api:rest_api_admin.adoc#tag/Session/operation/post_db-_session[POST /+{db}+/_session] endpoint.
...
* *expirationDate* corresponds to the cookie's expiration time. The endpoint's xref:rest-api:rest_api_admin.adoc#tag/Session/operation/post_db-_session[API reference] contains more information about how the expiration time is automatically extended according to the user session activity.
...
xref:rest-api:rest_api_public.adoc#tag/Session/operation/post_db-_session[+POST /{db}/_session+]
