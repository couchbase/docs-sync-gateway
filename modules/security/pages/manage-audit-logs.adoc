= Manage Audit Logs
:page-aliases: ROOT:manage-audit-logs.adoc
...
* xref:configuration:configuration-schema-bootstrap.adoc[Bootstrap Configuration Schema].

* xref:configuration:configuration-schema-database.adoc[Database Configuration Schema].

* xref:rest-api:rest_api_admin.adoc[Admin REST API].
...
To view the list of audit events, see xref:security:audit-log-events.adoc[]
...
For further bootstrap configuration options, see xref:configuration:configuration-schema-bootstrap.adoc[].
...
You can configure audit events at runtime without modifying the entire database configuration using the following HTTP request methods with the xref:rest-api:rest_api_admin.adoc[Admin REST API]:

* xref:rest-api:rest_api_admin.adoc#tag/Database-Configuration/operation/get_db-_config-audit[GET /{db}/_config/audit]
* xref:rest-api:rest_api_admin.adoc#tag/Database-Configuration/operation/put_db-_config-audit[PUT /{db}/_config/audit (replace)]
* xref:rest-api:rest_api_admin.adoc#tag/Database-Configuration/operation/post_db-_config-audit[POST /{db}/_config/audit (upsert)]
...
For more information, see xref:access-control:access-control-concepts.adoc#lbl-sgw-users[Sync Gateway defined Users and Roles].
...
For more information, see xref:access-control:access-control-concepts.adoc#lbl-rbac-users[RBAC Users].
...
* xref:manage:sgcollect-info.adoc[]

* xref:rest-api:rest_api_admin.adoc[Admin REST API Reference]

* xref:ROOT:rest_api_admin_static.adoc[Admin REST API Reference]
