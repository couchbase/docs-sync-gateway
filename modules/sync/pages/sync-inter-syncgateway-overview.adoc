...
:page-aliases: ROOT:learn/icr-sgreplicate.adoc, ROOT:icr-sgreplicate.adoc, ROOT:sync-inter-syncgateway-overview.adoc
...
image::ROOT:icr-replication-overview.svg[]
...
[[icr-cloud-to-edge]]
.Cloud-to-edge synchronization
image::ROOT:icr-cloud-to-edge200712.svg[,600]
...
[[icr-active-mobile]]
.Active-to-active mobile synchronization
image::ROOT:icr-active-mobile-sync200713.svg[,600]
...
For detailed configuration of collections parameters (`collections_enabled`, `collections_local`, `collections_remote`), see xref:configuration:configuration-schema-isgr.adoc#replication[Run Inter-Sync Gateway Replication Configuration Schema].
...
include::ROOT:partial$incpg-icr-availability.adoc[leveloffset=+1]


== Conflict Resolution


include::ROOT:partial$incpg-icr-conflict.adoc[tags=overview-full, leveloffset=+1]
